...
func main() {
  ...
  voltimeout := flag.Duration("voltimeout", 10*time.Millisecond, "Volume servers must respond to GET/HEAD requests in this amount of time or they are considered down, as duration")
  flag.Parse()
